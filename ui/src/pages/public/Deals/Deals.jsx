        ...
        <div className="max-w-[1280px] mx-auto px-[16px] py-[48px]">
          ...
          {dealsProducts.length > 0 ? (
            ...
            <div className="text-center py-[60px]">
              <Percent className="w-[48px] h-[48px] text-[#9CA3AF] mx-auto mb-[16px]" />
              <p className="text-[18px] text-[#6B7280] mb-[16px]">
                {t("deals.noDeals")}
              </p>
              <Link
                to="/shop"
                className="inline-flex px-[24px] py-[12px] bg-[#3B82F6] text-white font-semibold rounded-[12px] hover:bg-[#2563EB] transition-colors"
              >
                {t("home.shopNow")}
              </Link>
            </div>
