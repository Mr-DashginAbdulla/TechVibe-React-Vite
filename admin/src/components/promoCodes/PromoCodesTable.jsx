        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#E5E7EB] bg-[#F9FAFB]">
              <th className="text-left px-[20px] py-[14px] text-[12px] font-semibold text-[#6B7280] uppercase tracking-wider">
                {t("promoCodes.code")}
              </th>
              <th className="text-left px-[20px] py-[14px] text-[12px] font-semibold text-[#6B7280] uppercase tracking-wider">
                {t("promoCodes.type")}
              ...
              <th className="text-right px-[20px] py-[14px] text-[12px] font-semibold text-[#6B7280] uppercase tracking-wider">
                {t("common.actions")}
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#F3F4F6]">
            {promoCodes.map((promo) => (
              ...
              >
                ...
                <td className="px-[20px] py-[16px] text-[14px] font-semibold text-[#111827]">
                  {formatDiscount(promo)}
                </td>
                <td className="px-[20px] py-[16px] text-[14px] text-[#374151]">
                  ${promo.minOrder}
                </td>
                <td className="px-[20px] py-[16px] text-[14px] text-[#374151]">
                  {promo.usedCount}
